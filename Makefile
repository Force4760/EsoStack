...
build:
	...
	go build -tags "app" -ldflags "-X github.com/force4760/esostack/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/force4760/esostack/version.BuildDate=${BUILD_DATE}" -o bin/${BIN_NAME}_app
